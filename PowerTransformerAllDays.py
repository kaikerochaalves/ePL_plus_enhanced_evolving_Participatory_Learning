...
# Plot the graphic of the actual time series and the ePL+ predictions
plt.plot(y_test1, label='Actual Value', color='red')
plt.plot(OutputTestDenormalized1, color='blue', label='ePL+')
plt.ylabel('Output')
plt.xlabel('Samples')
plt.legend()
plt.show()
...
plt.plot(OutputTestDenormalized2, color='blue', label='ePL+')
plt.ylabel('Output')
plt.xlabel('Samples')
plt.legend()
plt.show()
